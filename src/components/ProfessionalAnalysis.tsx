...
export const ProfessionalAnalysis = () => {
  const [selectedReport, setSelectedReport] = useState<'rop' | 'drilling' | 'geothermal' | null>(null);
  ...
  const analyses = [
    ...
    },
    {
      ...
      icon: CheckCircle,
      color: "text-blue-600",
      reportType: "geothermal" as const
    }
  ];
  ...
  const handleViewReport = (reportType: 'rop' | 'drilling' | 'geothermal') => {
            ...
            return (
              <Card key={index} className="p-6 border-orange-100 hover:shadow-lg transition-shadow">
                ...
                <Button 
                  ...
                  onClick={() => handleViewReport(analysis.reportType)}
                >
